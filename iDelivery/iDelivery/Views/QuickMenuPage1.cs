...
namespace iDelivery
{
	public class QuickMenuPage1 : ContentPage
	{


		public QuickMenuPage1 ()
		{
			...
			var label = new Label
			{
				Text = "Get Urgent, Resident, Commercial, Cash, Card",
		...
		{
			await DisplayAlert("Send to server","Check Condition and get the Address", "OK");
